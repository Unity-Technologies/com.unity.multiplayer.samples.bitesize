...
namespace Unity.Multiplayer.Samples.SocialHub.Physics
{
    ...
    struct CollisionMessageInfo : INetworkSerializable
    {
        ...
        public ulong DestinationNetworkObjId;
        public ushort DestinationBehaviourId;
        ...
        {
            get { return GetFlag((uint)CollisionType.DebugCollision); }

            set { SetFlag(value, (uint)CollisionType.DebugCollision); }
        }
        ...
        public void NetworkSerialize<T>(BufferSerializer<T> serializer) where T : IReaderWriter
        {
            ...
            if (DebugCollisionsEnabled)
            {
                ...
                serializer.SerializeValue(ref DestinationNetworkObjId);
                serializer.SerializeValue(ref DestinationBehaviourId);
            }
        }
    }
}
