...
{
    /// <summary>
    /// This is just a copy of <see cref="NetworkTransform"/> but IsOwner is replaced with IsServer for server authority.
    /// </summary>
    public class ServerNetworkTransform : NetworkBehaviour
    {
